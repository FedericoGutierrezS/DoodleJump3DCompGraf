		...
		*channels[0].boolean_play = jetp->getOnPlayer();
		...
		if (jetp->getOnPlayer()) {
			if(jetLeftEmitter == nullptr)
				jetLeftEmitter = new ParticleEmitter(new Vector3(jug->getPos()->getX(), jug->getPos()->getY(), jug->getPos()->getZ()), new Vector3(0, -1, 0), new Vector3(1, 0.25, 0), 1, new Vector3(0, 0, 0), 0, 30, 0.15, 0.5, 1, new Vector3(0, -10, 0), true, true);
			if (jetRightEmitter == nullptr)
				jetRightEmitter = new ParticleEmitter(new Vector3(jug->getPos()->getX(), jug->getPos()->getY(), jug->getPos()->getZ()), new Vector3(0, -1, 0), new Vector3(1, 0.25, 0), 1, new Vector3(0, 0, 0), 0, 30, 0.15, 0.5, 1, new Vector3(0, -10, 0), true, true);
